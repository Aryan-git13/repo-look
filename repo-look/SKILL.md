...
## Example usage
```
/repo-look                                      # auto-split, deep mode
/repo-look --mode interview --split both --save
/repo-look --split backend --depth file
/repo-look --path ./apps/web --mode quick
claude --skill repo-look --path /repo --mode interview
```
